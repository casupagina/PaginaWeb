...
const ofertaOriente = [
  {
    ...
    carreras: [
      "Lic. Nutrición",
      "M. Sociología de la Salud",
      "Lic. Médicina Veterinaría y Zootecnia",
    ],
  },
  {
    area: "Salud",
    space: "Valle de Chalco",
    carreras: ["Lic. Enfermeria", "M. en Enfermería"],
  },
  {
    area: "Salud",
    space: "Nezahualcóyotl",
    carreras: ["Lic. Educación para la salud", "M. Psicología de la salud"],
  },
  { area: "Salud", space: "Chimalhuacan", carreras: ["Médico cirujano"] },

  { area: "Derecho", space: "Amecameca", carreras: ["Lic. Derecho"] },
  { area: "Derecho", space: "Texcoco", carreras: ["Lic. Derecho"] },
  { area: "Derecho", space: "Valle de Chalco", carreras: ["Lic. Derecho"] },
  { area: "Derecho", space: "Chimalhuacan", carreras: ["Lic. Derecho"] },

  {
    area: "Territorio",
    space: "Amecameca",
    carreras: ["Doc. Sustentabilidad para el desarrollo"],
  },
  {
    area: "Territorio",
    space: "Nezahualcóyotl",
    carreras: ["Ing. en Transporte", "Lic. Seguridad Ciudadana"],
  },
  {
    area: "Territorio",
    space: "Texcoco",
    carreras: ["M. Estudios socioterritoriales"],
  },
  {
    area: "Territorio",
    space: "Chimalhuacan",
    carreras: ["Lic. Seguridad Ciudadana", "Lic. Adm. de Obra Urbana"],
  },

  {
    area: "Software y Ciencias Digitales",
    space: "Nezahualcóyotl",
    carreras: ["Ing. en sistemas inteligentes"],
  },
  {
    area: "Software y Ciencias Digitales",
    space: "Texcoco",
  ...
  },
  {
    area: "Software y Ciencias Digitales",
    space: "Valle de Chalco",
    carreras: ["Ing. En Computación", "M. en C. de la Computación"],
  },

  {
    area: "Económicas y Administrativas",
    space: "Amecameca",
    carreras: [
      "Lic. Administración",
      "Lic. Contaduría",
      "Lic. Ciencias Políticas y Adm. Pública",
  ...
  },
  {
    ...
    carreras: [
      ...
      "Lic. Contaduría",
      "Lic. Economía",
      "D. S. Derechos Humanos",
    ],
  },
  {
    area: "Económicas y Administrativas",
    space: "Valle de Chalco",
    carreras: ["Lic. Contaduría"],
  },
  {
    area: "Económicas y Administrativas",
    space: "Nezahualcóyotl",
    carreras: ["Lic. Comercio Internacional"],
  },

  {
    area: "Otras",
    space: "Amecameca",
    carreras: ["Lic. Lengua y Literatura Hispánica", "D. Educación Literaria"],
  },
  {
    area: "Otras",
    space: "Texcoco",
    carreras: ["Lic. Lenguas", "Lic. Turismo"],
  },
  {
    area: "Otras",
    space: "Valle de Chalco",
    carreras: ["Lic. Diseño Industrial"],
  },
];
...
const fichasMunicipios = {
  //  REGIÓN SUR
  amecameca: ["img/Imagenes_ficahas/Amecameca/3.png"],
  chalco: ["img/Imagenes_ficahas/Chalco/1.png"],
  chimalhuacan: ["img/Imagenes_ficahas/Chimalhuacan/2.png"],
  texcoco: ["img/Imagenes_ficahas/Texcoco/1.png"],
  nezahualcoyotl: ["img/Imagenes_ficahas/Nezahualcoyotl/4.png"],

  //  REGIÓN SUR
  temascaltepec: ["img/Imagenes_ficahas/Temascaltepec/6.png"],
  tenancingo: ["img/Imagenes_ficahas/Tenancingo/5.png"],
  atlacomulco: ["img/Imagenes_ficahas/Atlacomulco/8.png"],
  santiagotianguistenco: ["img/Imagenes_ficahas/Tianguistenco/7.png"],
};
...
function mostrarFichaImagen(municipio) {
  // 1. Limpiamos el texto para que coincida con tu diccionario (ej. "Santiago Tianguistenco" -> "santiagotianguistenco")
  ...
  // 2. Buscamos la ruta de la imagen en tu constante fichasMunicipios
  const imgPath = fichasMunicipios[munKey] ? fichasMunicipios[munKey][0] : null;
  ...
  if (imgPath) {
    // Si encontramos la imagen: Ocultamos la vista por defecto y mostramos la imagen individual
    imgElement.src = imgPath.startsWith("img/") ? imgPath : `img/${imgPath}`;
    imgElement.style.display = "block";
    placeholder.style.display = "none";
  } else {
    // Si por alguna razón no hay imagen para ese municipio: Mostramos una alerta y dejamos la vista por defecto
    alert(`La ficha para ${municipio} se encuentra en proceso.`);
    imgElement.style.display = "none";
    placeholder.style.display = "flex"; // "flex" es importante aquí para que las dos imágenes se sigan viendo bien acomodadas
  }
}
...
function cargarMapaRegion(region) {
  ...
  if (!mapaRegional) {
    ...
    if (!capasYaCargadas) {
      Object.keys(configCapas).forEach((nom) => {
        capasTematicas[nom] = L.layerGroup();
        capasTematicas[nom].on("add", () => {
          if (typeof actualizarLeyenda === "function") actualizarLeyenda(nom);
        });
        ...
        fetch(`http://localhost:5000/api/${configCapas[nom].url}`)
          ...
          .then((data) => {
            ...
            }).addTo(capasTematicas[nom]);
          });
      });

      L.control
        .layers(capasTematicas, null, {
          collapsed: false,
          position: "topright",
        })
        .addTo(mapaRegional);
  ...
  capaMunicipiosActiva = L.geoJSON(datosMunicipios, {
    style: (feature) => {
      ...
      return {
        fillColor: esSeleccionado ? "#848482" : "transparent", // Transparente si no es de la región
